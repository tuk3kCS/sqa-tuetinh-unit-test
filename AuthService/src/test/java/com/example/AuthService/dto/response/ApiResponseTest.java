...
class ApiResponseTest {
    ...
    /**
     * Test Case ID: TC_AUTH_ApiResponse_success_001
     ...
     */
    @Test
    @DisplayName("TC_AUTH_ApiResponse_success_001: success(message) - tạo thành công")
    void TC_AUTH_ApiResponse_success_001() {
    ...
    /**
     * Test Case ID: TC_AUTH_ApiResponse_success_002
     ...
     */
    @Test
    @DisplayName("TC_AUTH_ApiResponse_success_002: success với message rỗng")
    void TC_AUTH_ApiResponse_success_002() {
    ...
    /**
     * Test Case ID: TC_AUTH_ApiResponse_success_003
     ...
     */
    @Test
    @DisplayName("TC_AUTH_ApiResponse_success_003: success với message null")
    void TC_AUTH_ApiResponse_success_003() {
    ...
    /**
     * Test Case ID: TC_AUTH_ApiResponse_successWithData_001
     ...
     */
    @Test
    @DisplayName("TC_AUTH_ApiResponse_successWithData_001: success(message, data) - tạo thành công")
    void TC_AUTH_ApiResponse_successWithData_001() {
    ...
    /**
     * Test Case ID: TC_AUTH_ApiResponse_successWithData_002
     ...
     */
    @Test
    @DisplayName("TC_AUTH_ApiResponse_successWithData_002: success với data là List")
    void TC_AUTH_ApiResponse_successWithData_002() {
    ...
    /**
     * Test Case ID: TC_AUTH_ApiResponse_successWithData_003
     ...
     */
    @Test
    @DisplayName("TC_AUTH_ApiResponse_successWithData_003: success với data null")
    void TC_AUTH_ApiResponse_successWithData_003() {
    ...
    /**
     * Test Case ID: TC_AUTH_ApiResponse_error_001
     ...
     */
    @Test
    @DisplayName("TC_AUTH_ApiResponse_error_001: error(message) - tạo thành công")
    void TC_AUTH_ApiResponse_error_001() {
    ...
    /**
     * Test Case ID: TC_AUTH_ApiResponse_error_002
     ...
     */
    @Test
    @DisplayName("TC_AUTH_ApiResponse_error_002: error với message chi tiết")
    void TC_AUTH_ApiResponse_error_002() {
    ...
    /**
     * Test Case ID: TC_AUTH_ApiResponse_error_003
     ...
     */
    @Test
    @DisplayName("TC_AUTH_ApiResponse_error_003: Phân biệt success và error")
    void TC_AUTH_ApiResponse_error_003() {
    ...
    /**
     * Test Case ID: TC_AUTH_ApiResponse_error_004
     ...
     */
    @Test
    @DisplayName("TC_AUTH_ApiResponse_error_004: Error response data luôn null")
    void TC_AUTH_ApiResponse_error_004() {
