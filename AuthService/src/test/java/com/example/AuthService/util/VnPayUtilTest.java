...
class VnPayUtilTest {
    ...
    /**
     * Test Case ID: TC_AUTH_VnPayUtil_buildHashData_001
     ...
     */
    @Test
    @DisplayName("TC_AUTH_VnPayUtil_buildHashData_001: Tạo hash data thành công")
    void TC_AUTH_VnPayUtil_buildHashData_001() {
    ...
    /**
     * Test Case ID: TC_AUTH_VnPayUtil_buildHashData_002
     ...
     */
    @Test
    @DisplayName("TC_AUTH_VnPayUtil_buildHashData_002: Hash data URL encode ký tự tiếng Việt")
    void TC_AUTH_VnPayUtil_buildHashData_002() {
        Map<String, String> params = new TreeMap<>();
    ...
    /**
     * Test Case ID: TC_AUTH_VnPayUtil_buildHashData_003
     ...
     */
    @Test
    @DisplayName("TC_AUTH_VnPayUtil_buildHashData_003: Hash data từ map rỗng")
    void TC_AUTH_VnPayUtil_buildHashData_003() {
        Map<String, String> params = new TreeMap<>();
    ...
    /**
     * Test Case ID: TC_AUTH_VnPayUtil_buildHashData_004
     ...
     */
    @Test
    @DisplayName("TC_AUTH_VnPayUtil_buildHashData_004: Sắp xếp params đúng thứ tự")
    void TC_AUTH_VnPayUtil_buildHashData_004() {
    ...
    /**
     * Test Case ID: TC_AUTH_VnPayUtil_buildQueryString_001
     ...
     */
    @Test
    @DisplayName("TC_AUTH_VnPayUtil_buildQueryString_001: Tạo query string thành công")
    void TC_AUTH_VnPayUtil_buildQueryString_001() {
        Map<String, String> params = new TreeMap<>();
        params.put("vnp_Amount", "1000000");
    ...
    /**
     * Test Case ID: TC_AUTH_VnPayUtil_buildQueryString_002
     ...
     */
    @Test
    @DisplayName("TC_AUTH_VnPayUtil_buildQueryString_002: Query string encode ký tự đặc biệt")
    void TC_AUTH_VnPayUtil_buildQueryString_002() {
        Map<String, String> params = new TreeMap<>();
    ...
    /**
     * Test Case ID: TC_AUTH_VnPayUtil_buildQueryString_003
     ...
     */
    @Test
    @DisplayName("TC_AUTH_VnPayUtil_buildQueryString_003: Query string với 1 tham số")
    void TC_AUTH_VnPayUtil_buildQueryString_003() {
        Map<String, String> params = new TreeMap<>();
    ...
    /**
     * Test Case ID: TC_AUTH_VnPayUtil_hmacSHA512_001
     ...
     */
    @Test
    @DisplayName("TC_AUTH_VnPayUtil_hmacSHA512_001: Tạo HMAC SHA512 thành công")
    void TC_AUTH_VnPayUtil_hmacSHA512_001() {
    ...
    /**
     * Test Case ID: TC_AUTH_VnPayUtil_hmacSHA512_002
     ...
     */
    @Test
    @DisplayName("TC_AUTH_VnPayUtil_hmacSHA512_002: HMAC SHA512 là deterministic")
    void TC_AUTH_VnPayUtil_hmacSHA512_002() {
    ...
    /**
     * Test Case ID: TC_AUTH_VnPayUtil_hmacSHA512_003
     ...
     */
    @Test
    @DisplayName("TC_AUTH_VnPayUtil_hmacSHA512_003: Key khác cho output khác")
    void TC_AUTH_VnPayUtil_hmacSHA512_003() {
    ...
    /**
     * Test Case ID: TC_AUTH_VnPayUtil_hmacSHA512_004
     ...
     */
    @Test
    @DisplayName("TC_AUTH_VnPayUtil_hmacSHA512_004: HMAC với data rỗng")
    void TC_AUTH_VnPayUtil_hmacSHA512_004() {
    ...
    /**
     * Test Case ID: TC_AUTH_VnPayUtil_buildRefundHashData_001
     ...
     */
    @Test
    @DisplayName("TC_AUTH_VnPayUtil_buildRefundHashData_001: Refund hash data không encode")
    void TC_AUTH_VnPayUtil_buildRefundHashData_001() {
        Map<String, String> params = new LinkedHashMap<>();
        params.put("vnp_Amount", "1000000");
    ...
    /**
     * Test Case ID: TC_AUTH_VnPayUtil_buildRefundHashData_002
     ...
     */
    @Test
    @DisplayName("TC_AUTH_VnPayUtil_buildRefundHashData_002: Bỏ qua entry null/rỗng")
    void TC_AUTH_VnPayUtil_buildRefundHashData_002() {
        Map<String, String> params = new LinkedHashMap<>();
        params.put("a", "1");
        params.put("b", null);
        params.put("c", "");
    ...
    /**
     * Test Case ID: TC_AUTH_VnPayUtil_buildRefundHashData_003
     ...
     */
    @Test
    @DisplayName("TC_AUTH_VnPayUtil_buildRefundHashData_003: Tất cả entry rỗng")
    void TC_AUTH_VnPayUtil_buildRefundHashData_003() {
        Map<String, String> params = new LinkedHashMap<>();
        params.put("a", null);
        params.put("b", "");
    ...
    /**
     * Test Case ID: TC_AUTH_VnPayUtil_buildRefundHashData_004
     ...
     */
    @Test
    @DisplayName("TC_AUTH_VnPayUtil_buildRefundHashData_004: Không encode ký tự đặc biệt")
    void TC_AUTH_VnPayUtil_buildRefundHashData_004() {
        Map<String, String> params = new LinkedHashMap<>();
