...
# Notes: auth_headers cung cấp userId=1
@patch("app.controllers.agent_controller.AgentService")
def test_chat_success(mock_service, client, auth_headers):
...
@patch("app.controllers.agent_controller.AgentService")
def test_chat_missing_message(mock_service, client, auth_headers):
    resp = client.post(
        "/api/v3/agent/chat",
        json={},
        headers=auth_headers
...
@patch("app.controllers.agent_controller.AgentService")
def test_chat_no_body(mock_service, client, auth_headers):
    resp = client.post(
        "/api/v3/agent/chat",
        headers=auth_headers,
...
@patch("app.controllers.agent_controller.AgentService")
def test_chat_user_id_mismatch(mock_service, client, auth_headers):
    resp = client.post(
        "/api/v3/agent/chat",
...
# Notes: Happy path
@patch("app.controllers.agent_controller.AgentService")
def test_get_meal_plan_success(mock_service, client, auth_headers):
...
@patch("app.controllers.agent_controller.AgentService")
def test_get_meal_plan_no_plan(mock_service, client, auth_headers):
    mock_service.get_meal_plan.return_value = {
...
def test_create_meal_plan_success(mock_profile_client, mock_service, client, auth_headers):
...
@patch("app.controllers.agent_controller.UserProfileClient")
def test_create_meal_plan_profile_service_unavailable(mock_profile_client, client, auth_headers):
...
@patch("app.controllers.agent_controller.UserProfileClient")
def test_create_meal_plan_dto_validation_error(mock_profile_client, client, auth_headers):
...
# Notes: Happy path
@patch("app.controllers.agent_controller.AgentService")
def test_get_workout_plan_success(mock_service, client, auth_headers):
...
@patch("app.controllers.agent_controller.AgentService")
@patch("app.controllers.agent_controller.UserProfileClient")
def test_create_workout_plan_success(mock_profile_client, mock_service, client, auth_headers):
...
@patch("app.controllers.agent_controller.UserProfileClient")
def test_create_workout_plan_service_unavailable(mock_profile_client, client, auth_headers):
...
def test_post_workout_plan_db_success(mock_create, client, auth_headers):
...
@patch("app.services.workout_plan_service.WorkoutPlanService.create")
def test_post_workout_plan_db_missing_plan(mock_create, client, auth_headers):
    resp = client.post(
        "/api/v3/agent/workout-plan/db",
        json={},
        headers=auth_headers
...
@patch("app.services.workout_plan_service.WorkoutPlanService.create")
def test_post_workout_plan_db_already_exists(mock_create, client, auth_headers):
...
def test_put_workout_plan_db_success(mock_update, client, auth_headers):
...
# Notes: Nhánh ValueError
@patch("app.services.workout_plan_service.WorkoutPlanService.update")
def test_put_workout_plan_db_not_found(mock_update, client, auth_headers):
...
def test_delete_workout_plan_db_success(mock_delete, client, auth_headers):
...
# Notes: Nhánh ValueError
@patch("app.services.workout_plan_service.WorkoutPlanService.delete")
def test_delete_workout_plan_db_not_found(mock_delete, client, auth_headers):
...
def test_post_meal_plan_db_success(mock_create, client, auth_headers):
...
def test_put_meal_plan_db_success(mock_update, client, auth_headers):
...
# Notes: Nhánh ValueError
@patch("app.services.meal_plan_service.MealPlanService.update")
def test_put_meal_plan_db_not_found(mock_update, client, auth_headers):
...
def test_delete_meal_plan_db_success(mock_delete, client, auth_headers):
    resp = client.delete(
        "/api/v3/agent/meal-plan/db",
        headers=auth_headers
    )
...
# Notes: Nhánh ValueError
@patch("app.services.meal_plan_service.MealPlanService.delete")
def test_delete_meal_plan_db_not_found(mock_delete, client, auth_headers):
